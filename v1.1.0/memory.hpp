...
namespace memory
{
	...
	[[noreturn]] inline void _class_destory(Ty& elem , bool value)
	{
		if (value == true)
			elem.~Ty();
	}
	...
	//set pointer null
	template<typename Ty>
	[[noreturn]] inline void _pointer_destory(Ty& elem , lib_type::true_type_tag)
	{
		elem = nullptr;
	}
	...
	//do nothing
	template<typename Ty>
	[[noreturn]] inline void _pointer_destory(Ty& elem , lib_type::false_type_tag)
	{
	}

	//free pod data
	template<typename Ty>
	[[noreturn]] inline void _elem_destory(Ty& elem , lib_type::true_type_tag)
	{
	...
	//free non-pod data
	template<typename Ty>
	[[noreturn]] inline void _elem_destory(Ty& elem , lib_type::false_type_tag)
	{
	...
	template<typename Ty>
	[[noreturn]] inline void elem_destory(Ty& elem)
	{
