...
{
	_NODISCARD T operator()(const T& a , const T& b) const
	{
		return a + b;
	}
};
...
{
	_NODISCARD T operator()(const T& a) const
	{
		return -a;
	}
};
...
template<typename T>
_NODISCARD inline T identity_element(plus<T>)
{
	return T(0);
}

template<typename T>
_NODISCARD inline T identity_element(multiplies<T>)
{
	return T(1);
}
...
{
	_NODISCARD bool operator()(const T& a , const T& b) const
	{
		return a == b;
	}
};
...
//and
template<typename T>
struct logical_and :public bianry_function<T , T , bool>
{
	_NODISCARD bool operator()(const T& a , const T& b) const
	{
		return a && b;
...
{
	_NODISCARD bool operator()(const T& a) const
	{
		return !a;
	}
};
...
struct unary_negate :public unary_function<typename functor::argument_type , bool>
{
	...
	public:
		...
		_NODISCARD bool operator()(const typename functor::argument_type& arg) const
		{
			return !func(arg);
		}
};
...
//helper function
template<typename functor>
_NODISCARD inline unary_negate<functor> not1(const functor& obj)
{
...
template<typename functor>
_NODISCARD inline bianry_negate<functor> not2(const functor& obj)
{
										...
										typename operation::result_type>
{
	...
	public:
		...
		_NODISCARD typename operation::result_type operator()(const typename operation::second_argument_type& x) const
		{
			return op(value,x);
		}
};
...
_NODISCARD inline binder1st<operation> bind1st(const operation& op , const t& x)
{
										...
										typename operation::result_type>
{
	...
	public:
		...
		_NODISCARD typename operation::result_type operator()(const typename operation::first_argument_type& x) const
		{
			return op(x , value);
		}
};
...
template<typename operation,typename t>
_NODISCARD inline binder2nd<operation> bind2nd(const operation& obj , const t& x)
{
											...
											typename operation1::result_type>
{
	...
	public:
		...
		_NODISCARD typename operation1::result_type operator()(const typename operation2::argument_type& x) const
		{
			return op1(op2(x));
		}
};
...
template<typename operation1,typename operation2>
_NODISCARD inline unary_compose<operation1 , operation2> compose1(const operation1& op1 , const operation2& op2)
{
...
struct pointer_to_unary_function :public unary_function<Arg , Result>
{
	...
	public:
		...
		_NODISCARD Result operator()(Arg x) const
		{
			return ptr(x);
		}
};
...
struct pointer_to_bianry_function :public bianry_function<Arg1 , Arg2 , Result>
{
	...
	public:
		...
		_NODISCARD Result operator()(Arg1 x , Arg2 y) const
		{ 
			return ptr(x , y);
		}
};
...
template<typename Arg,typename Result>
_NODISCARD inline pointer_to_unary_function<Arg , Result> ptr_fun(Result (*x)(Arg))
{
	return pointer_to_unary_function<Arg , Result>(x);
}

template<typename Arg1,typename Arg2,typename Result>
_NODISCARD inline pointer_to_bianry_function<Arg1 , Arg2 , Result> ptr_fun(Result (*x)(Arg1 , Arg2))
{
...
struct mem_fun_t : public unary_function<t* , s>
{
	...
	public:
		...
		_NODISCARD s operator()(t* p) const
		{
			return (p->*f)();
		}
};
...
struct const_mem_fun_t :public unary_function<const t* , s>
{
	...
	public:
		...
		_NODISCARD s operator()(const t* p) const
		{
			return (p->*f)();
		}
};
...
struct mem_fun_ref_t :public unary_function<t , s>
{
	...
	public:
		...
		_NODISCARD s operator ()(t& r) const
		{
			return(r.*f)();
		}
};
...
class const_mem_fun_ref_t :public unary_function<t , s>
{
	...
	public:
		...
		_NODISCARD s operator()(const t& r) const
		{
			return (r.*f)();
		}
};
...
struct mem_fun1_t :public bianry_function<t* , a , s>
{
	...
	public:
		...
		_NODISCARD s operator()(t* p , a x) const
		{
			return (p->*f)(x);
		}
};
...
struct const_mem_fun1_t :public bianry_function<const t* , a , s>
{
	...
	public:
		...
		_NODISCARD s operator()(const t* p , a x) const
		{
			return (p->*f)(x);
		}
};
...
struct mem_fun1_ref_t :public bianry_function<t , a , s>
{
	...
	public:
		...
		_NODISCARD s operator()(t& r , a x) const
		{
			return (r.*f)(x);
		}
};
...
struct const_mem_fun1_ref_t :public bianry_function<t , a , s>
{
	...
	public:
		...
		_NODISCARD s operator()(const t& r , a x) const
		{
			return (r.*f)(x);
		}
};
...
//without argument
template<typename s,typename t>
_NODISCARD inline mem_fun_t<s , t> mem_fun(s (t::* f)())
{
	return mem_fun_t<s , t>(f);
}

template<typename s,typename t>
_NODISCARD inline const_mem_fun_t<s , t> mem_fun(s (t::* f)() const)
{
	return const_mem_fun_t<s , t>(f);
}

template<typename s,typename t>
_NODISCARD inline mem_fun_ref_t<s , t> mem_fun_ref(s (t::* f)())
{
	return mem_fun_ref_t<s , t>(f);
}

template<typename s,typename t>
_NODISCARD inline const_mem_fun_ref_t<s , t> mem_fun_ref(s (t::* f)() const)
{
...
//accept a argument
template<typename s,typename t,typename a>
_NODISCARD inline mem_fun1_t<s , t , a> mem_fun(s (t::* f)(a))
{
	return mem_fun1_t<s , t , a>(f);
}

template<typename s,typename t,typename a>
_NODISCARD inline const_mem_fun1_t<s , t , a> mem_fun(s (t::* f)(a) const)
{
	return const_mem_fun1_t<s , t , a>(f);
}

template<typename s,typename t,typename a>
_NODISCARD inline mem_fun1_ref_t<s , t , a> mem_fun_ref(s (t::* f)(a))
{
	return mem_fun1_ref_t<s , t , a>(f);
}

template<typename s,typename t,typename a>
_NODISCARD inline const_mem_fun1_ref_t<s , t , a> mem_fun_ref(s (t::* f)(a) const)
{
